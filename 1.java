...
/*
Chit No 11 -
Create Project Plan Using Gant Chart
...
A:
A Gantt Chart is a visual project management tool that shows project tasks along a timeline.
It helps to plan, schedule, and track project progress by showing the start date, end date, duration, dependencies, and milestones for each task.

Q2. What is the purpose of using a Gantt Chart in project management?

A:
The Gantt Chart provides a clear visual timeline of when tasks start and finish, how they depend on each other, and helps ensure the project stays on schedule.
It helps in tracking progress, managing resources, and identifying delays.

Q3. What do you mean by Baseline in a Gantt Chart?

A:
A baseline is the original project plan before any changes are made.
It is used to compare planned progress vs. actual progress later on.
It helps monitor deviations from the original schedule.

Q4. What are milestones in a project?

A:
A milestone represents a significant achievement or key event in the project — for example, “Project Handover” or “UAT Completion”.
It usually has zero duration and is used to track project progress checkpoints.

Q5. What are task dependencies?

A:
Dependencies define the sequence in which tasks must be performed.
For example, Frontend Implementation depends on UI Design being completed first.
Common types:
...
Q6. What is a project calendar?

A:
A project calendar defines working and non-working days (e.g., weekends, holidays).
It helps scheduling tasks accurately by excluding non-working days.

Q7. What are project resources?

A:
Resources are people, equipment, or materials needed to complete tasks.
For example:

Team Lead → Work Type: Management

Designer → Work Type: Design

QA Team → Work Type: Testing

Q8. What is resource allocation?

A:
Resource allocation means assigning specific resources (people or teams) to tasks to ensure each task has what it needs to be completed on time.

Q9. What is duration in a project plan?

A:
Duration represents the total number of working days required to complete a task.
It excludes weekends or non-working days if a project calendar is applied.

Q10. What software can be used to create Gantt Charts?
...
Smartsheet, ClickUp, Trello, etc.

Q11. What are the advantages of Gantt Charts?

A:

Easy visualization of project progress
...
Q12. What are the limitations of Gantt Charts?

A:

Becomes complex for large projects

Doesn’t show resource overloading clearly

Needs frequent updating for accuracy

💻 PRACTICAL QUESTIONS AND ANSWERS
Q1. How did you specify the project name and start date?

A:
I entered the project name at the top of my Excel Gantt chart and set the start date (2025-11-10) in the first task (Project Kickoff).
All other tasks were scheduled relative to this start date.

Q2. How did you define and identify project tasks?

A:
I listed all major project activities, such as:
...
Each task represents a key phase in the project lifecycle.

Q3. How did you define task duration?

A:
For each task, I specified how many working days it would take (e.g., Design = 5 days, Frontend = 7 days).
The duration was used to calculate the End Date using the formula:
End Date = Start Date + Duration – 1.

Q4. How did you define milestones?

A:
I created a milestone for “Project Handover” with Duration = 0.
This represents a key completion point, shown as a diamond (◆) in the chart.

Q5. How did you define task dependencies?

A:
I used the Predecessor column to show dependencies:

Design (Task 2) depends on Project Kickoff (Task 1)

Frontend Implementation (Task 4) depends on Design and Setup (2,3)

UAT depends on Integration & Testing (Task 6), etc.
This defines the project sequence.

Q6. How did you define the project calendar?

A:
I assumed a Monday–Friday working week and excluded weekends from task durations, aligning all date calculations accordingly.

Q7. How did you define and assign project resources?

A:
I added columns for Resource Name and Resource Type:
...
Each resource was assigned to the corresponding task.

Q8. How did you baseline the project?

A:
I created Baseline Start, Baseline Duration, and Baseline End columns to record the original schedule.
These values will be used later to track if actual progress matches the baseline.

Q9. How did you make the Gantt chart visualization?

A:
I used Excel conditional formatting:

=AND(C$1 >= $C2, C$1 <= $E2)


This formula highlights the cells between Start and End dates, visually showing the task timeline.

Q10. What was the project start and end date in your plan?

A:

Project Start Date: 2025-11-10

Project End Date: 2025-12-04

The total duration of the project is 25 days (excluding weekends).

✅ Summary for Viva (Short Version)

Project Name: Web Application Development Plan
...
Purpose: To plan and visualize project timeline, tasks, dependencies, and resources.
*/